{
  ...
  outputs =
    ...
    let
      ...
      /*
      DOING: matthew added below to write out dependency on flakehub
      but upstream eelco recently added something similar but maybe more
      flexible, so I want to see if this can work well enough for us to
      go ahead and stop maintaining this diff
      ...
      overlays.default = final: prev:
        let
          ...
          sharedAttrs = {
            ...
            # DOING: see previous note about eelco's addition
